...
public class URLValidationPostTests {
    ...
    @Test
    public void testDoPostWithInvalidUrl() throws ServletException, IOException {
    ...
    @Test
    public void testDoPostWithInvalidEntity() throws ServletException, IOException {
        DispatcherServlet servlet = new DispatcherServlet();
        servlet.init();
    ...
    @Test
    public void testDoPostWithTooManyVariables() throws ServletException, IOException {
        DispatcherServlet servlet = new DispatcherServlet();
        servlet.init();
    ...
    @Test
    public void testDoPostWithoutEntity() throws ServletException, IOException {
        DispatcherServlet servlet = new DispatcherServlet();
        servlet.init();
